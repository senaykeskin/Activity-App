...
final EdgeInsets vertical12 = EdgeInsets.symmetric(vertical: 12);
...
final EdgeInsets top30 = EdgeInsets.only(top: 30);
final EdgeInsets bottom5 = EdgeInsets.only(bottom: 5);

final BorderRadius border10 = BorderRadius.circular(10);
final BorderRadius border15 = BorderRadius.circular(15);
final BorderRadius border20 = BorderRadius.circular(20);
final BorderRadius border50 = BorderRadius.circular(50);
